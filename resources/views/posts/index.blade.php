...
<body>
  <div class="main-container">
    ...
    <div class="d-flex justify-content-center align-items-center">
      <img src="{{ asset('images/inilogo.jpeg') }}" alt="Logo UsCare" class="img-fluid" style="width: 200px; height: 200px;">
  </div>  
      <hr>
      <ul class="nav flex-column">
        ...
        <li>
          <a href="https://www.lapor.go.id/instansi/kementerian-pemberdayaan-perempuan-dan-perlindungan-anak" class="nav-item-custom">
    ...
    <main class="feed align-items-center">
      ...
      <div class="post">
        ...
        <div class="mb-3">
          <textarea id="postContent" class="form-control" rows="3" placeholder="What's happening?"></textarea>
        </div>
        <div class="mb-3">
    ...
    <aside class="trending" style="color: #81609d">
      ...
      <ul>
        <li>#sebelum2024 - 5,314 posts</li>
        <li>#Halo2025 - 17.8K posts</li>
        <li>Hepi - 17.8K posts</li>
      </ul>
    </aside>
  </div>
